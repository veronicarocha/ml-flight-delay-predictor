...
# Limitações do Estudo
  Dados limitados a 2015 (apenas um ano)

  Clima não incluído nos dados originais

  Efeito cascata não completamente capturado

  Dados apenas dos EUA

# Próximos Passos
  Incorporar dados meteorológicos reais (precipitação, visibilidade)

  Adicionar features de congestionamento do aeroporto por horário

  Testar modelos de séries temporais para capturar sazonalidade

  Implementar sistema de alerta em tempo real para passageiros

  Expandir análise para múltiplos anos (2016-2019)